...
HOLIDAYS = {\
		...
		2030:[[1,2,3,14],[11],[20],[29],[3,4,5,6],[],[15],[11,12],[16,23],[14],[3,4,23],[23,28,29,30,31]]}  # キーは数値。祝日JSON。HOLIDAYS[年][月-1]で祝日の日のタプルが返る。日曜日の祝日も含まれる。
GAZOs = "Xp", "胃ｶ", "腸ｶ"
GAZOd = "CT", "MRI", "MRCP"
SHOCHIs = "ｶﾞｽ", "CV", "尿ｶﾃ", "気切", "ED", "PEG", "CART", "腹穿", "胸穿", "ｻﾝﾌﾟ"
ECHOs = "腹ｴ", "心ｴ", "頸ｴ", "肢ｴ"
